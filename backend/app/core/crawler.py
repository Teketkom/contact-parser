...
CONTACT_PAGE_KEYWORDS = [
    ...
    # Русские — подразделения и специалисты (КРИТИЧНО для не-директорских должностей)
    "подразделения", "отделы", "службы", "департаменты",
    "бухгалтерия", "юридический", "финансовый", "кадры", "hr",
    "производство", "закупки", "снабжение", "логистика",
    "инженерный", "технический", "конструкторский", "метрологи",
    "энергетик", "механик", "технолог", "безопасность", "охрана труда",
    "реквизиты", "карточка предприятия", "инн", "огрн",
    "вакансии", "тендеры", "закупочная деятельность",
    "пресс-служба", "новости компании", "раскрытие информации",
    "ежеквартальный отчет", "годовой отчет", "аффилированные лица",
    # Английские
    ...
    "departments", "divisions", "hr", "finance", "legal",
    "procurement", "engineering", "careers", "jobs",
]
